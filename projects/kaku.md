...
Kaku is an open source project by [Tw93](https://tw93.fun) with 5.2K GitHub stars. Kaku is a fast, GPU-rendered terminal emulator for macOS. Built with Rust for performance and Lua for configuration. Designed to be simple, beautiful, and responsive.
