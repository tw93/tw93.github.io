...
这对我这种做小工具的人来说其实是好消息。项目不大，但 README 和文档写得还算清楚，AI 就能在大站内容单薄的地方找到我。大概这就是为什么朋友们用 AI 搜的时候能看到 Pake 和 MiaoYan。

不过别高兴太早。AI 搜索增长很快，2025 年上半年同比涨了 527%，ChatGPT 到 2026 年 2 月周活 9 亿，引荐流量转化率大概是传统搜索的 5 倍。但目前 AI 搜索仍然只占总引荐流量不到 1%，更像是品牌可见性策略，不是流量策略。值得花一个小时整一整，不值得花一周。
