...
1. 常用配置：建议登录，便于同步。
   ...
   - 外观：主题：[NewTab](https://cdn.tw93.fun/blog/upic/aTyroT.zip)(打开浏览器扩展 管理，打开开发模式，选择加载解压缩扩展)，啥都没有的主题，自己写的；配置也是能关闭尽量管理，可见 [截图](https://gw.alipayobjects.com/zos/k/ja/5miZgk.jpg)
