...
feature: https://gw.alipayobjects.com/zos/k/i4/1.jpeg
summary: 前段时间 x-render 突破 4.8K Star，突破 4.8K Star，之前玩过的 gource 和 avconv 这两个库，想着可以用这两个技术来给她祝寿。
categories: Tool

---

前段时间 [x-render](https://github.com/alibaba/x-render) 突破 4.8K Star，之前玩过的 gource 和 avconv 这两个库，想着可以用这两个技术来给她祝寿。
