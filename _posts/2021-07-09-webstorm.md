...
<p style="margin-top:-5px;width:100%;text-align:center;font-size:12px">打开我 Mac 上最大的一个项目 <a href="https://github.com/alibaba/x-render" target="_blank">xRender</a>，没有插电情况下，实际的启动效果 <a href="https://qpluspicture.oss-cn-beijing.aliyuncs.com/up/QYtuow.mp4" target="_blank">录屏 mp4</a></p>
</div>
