...
summary: 我把最近半年用 Claude Code 积累的一些实际经验分享给大伙，两个账号每月氪金 40 刀。这篇文章主要围绕上下文管理、Skills、Hooks、Subagents、Prompt Caching 以及 CLAUDE.md 的设计展开，重点讨论怎样让协作过程更稳定、更可控，偏工程师技术视角的最佳实践，欢迎大伙一起交流。
categories: Share
---
...
<img src="https://cdn.tw93.fun/blog/upic/g1Ce7x.png" width="1000" alt="五个 MCP Server 占用 200K 上下文窗口 12.5% 的固定开销示意图" />
...
<img src="https://cdn.tw93.fun/blog/upic/DOPgjN.png" width="1000px" alt="/context 命令输出，可以看到各来源的 token 占比">
...
<img src="https://cdn.tw93.fun/blog/upic/6qvOIC.png" width="1000" alt="Plan Mode 将只读探索与实际执行分开的工作流程" />
...
<img src="https://cdn.tw93.fun/blog/upic/iOfkNM.png" width="800" alt="要求 AI 只做分析和设计、不写代码的 Plan Mode 示例 Prompt" />
...
<img src="https://cdn.tw93.fun/blog/upic/aMfLwM.png" width="1000px" alt="Finding the sweet spot">
...
<img src="https://cdn.tw93.fun/blog/upic/5J83L4.png" width="1000px" alt="Hooks 配置界面">
...
<img src="https://cdn.tw93.fun/blog/upic/O9aa1Q.png" width="1000px" alt="Hooks 在执行过程中的介入点">
...
Prompt 缓存是按模型区分的。假如你已经和 Opus 对话了 100K tokens，想问个简单问题，**切换到 Haiku 实际上比继续用 Opus 更贵**，因为要为 Haiku 重建整个缓存。确实需要切换的话，用 Subagent 交接：Opus 准备一条"交接消息"给另一个模型，说明需要完成的任务就行。
...
<img src="https://cdn.tw93.fun/blog/upic/XwDs5n.png" width="1000px" alt="/mcp 连接状态，可以看到各 server 的工具数量和 token 消耗">
