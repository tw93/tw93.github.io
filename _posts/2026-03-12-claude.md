...
## 概念边界：MCP / Plugin / Tools / Skills / Hooks / Subagents
...
我后面越用越觉得，给 Claude 的工具和给人写的 API 不是一回事。给 agent 的工具，目标是让它用对，功能堆得完不完整是其次。
...
这块很少有教程展开讲，但它其实很影响 Claude Code 的成本结构和很多设计取舍。
