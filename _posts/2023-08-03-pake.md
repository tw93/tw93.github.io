---
layout: post
title: Pake：用 Rust 和 Tauri 把网页打包成桌面应用
poem: 別有天地非人間
date: 2023-08-03 21:00:00
summary: Pake 用 Rust 和 Tauri 把网页打包成体积小、速度快的桌面应用。这篇来自一次跨端技术分享，记录 Pake 开源过程中的思考和经验，以及我在前端、Rust 和技术产品化上的一些想法。
categories: Creation
---
...
更完整的功能、安装方式和同类工具对比整理在 [Faberon](https://faberon.io/projects/pake)。
