...
categories: Share
feature: https://gw.alicdn.com/imgextra/i3/O1CN01Q0dqdd1CAp6Z1s5i4_!!6000000000041-2-tps-2300-1294.png
---
...
> 键盘左右可切换，右下角全屏按钮可全屏查看，鼠标移动到左侧边栏可查看目录。  
> 视频可见 B 站 [「Pake-利用 Rust 轻松构建跨端桌面应用」](https://www.bilibili.com/video/BV1Cz4y1W7sy/)

{::nomarkdown}

<div class="keynote-container">
<iframe id="postIframe" src="/images/keynote/2023-08-03-pake" title="Pake-利用 Rust 轻松构建轻量级应用" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
