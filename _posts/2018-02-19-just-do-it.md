...
17 年相关的关键词有**升 6、频道业务、Weex + Ui、双十一、开源、iOS**等。

###  业务相关

主要从 0 开始用 Weex 写了如下一些频道页面， 包括踩坑调研、富交互实现、后续组件的抽离和业务迭代维护，这里大概花费我**一年工作中 20% 左右的时间**。
...
以上值得一提的有 [Weex Ui 组件库](https://github.com/alibaba/weex-ui){:target="\_blank"} 的`建设开源` 和 `Weex 飞猪双十一会场性能体验优化`这两件事情。
...
详细可见 [**《Weex + Ui - Weex Conf 2018》**](http://tw93.com/2018-01-21/weex-conf-weex-ui.html){:target="\_blank"} 文章和[**《Weex + Ui Keynote》**](https://gw.alipayobjects.com/os/rmsportal/VCbkwAttfbolWixThpNc.pdf){:target="\_blank"}。
...
目前只处在入门水平，能看懂代码，[**会 iOS 业务开发**](https://gw.alipayobjects.com/os/rmsportal/NMtqzADzJjCotqznFNHA.mp4){:target="\_blank"}，可跑通上线发布流程，现在主要维护出境超市 iOS 这一块，搞懂这些大概**花费了我一年工作中 15% 的时间**，希望 2018 年，在 iOS 上面好好折腾一些好玩的东西，很期待。
...
明显发觉 2017 年性格“有点急躁”，遇到事情没有老手淡定，“急躁”的根源应该  自己  没有处理好心态有关，如何不被周围影响、不跟风，如何坚持自己的价值观这些都需要好好反思一下。
