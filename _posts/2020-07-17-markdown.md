...
### [github.com/tw93](https://github.com/tw93) 欢迎 Follow
...
豆瓣的动态信息当时有想过去用 python 爬对应的信息，但是实现下来会比较蹩脚，登录态需要隔一段时间去维护一下，恰好在处理个人页信息时候看到了如下 [feed rss](https://www.douban.com/feed/people/username/interests)，半小时就把本来一天的事情给做了；
