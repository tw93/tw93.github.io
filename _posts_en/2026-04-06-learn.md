...
![](https://cdn.tw93.fun/blog/pic/deep34.png)
...
Now that AI is here, my taste has not really changed. Things like "understand One Hundred Years of Solitude in 3 minutes," short dramas, or watching shows at double speed are not for me. I still prefer to choose good material and spend real time with it. Moving slower and truly understanding something beats rushing through a pile of summaries and ending up with nothing solid.

Recently, while writing my "You Don't Know Claude Code" and Agent series, I had plenty of gaps to work through alongside the parts I knew. Luckily, I had saved a lot of related material before, so this became a good chance to finally clear that backlog, really understand the topic, and turn it into output. I have always felt that input alone is overrated. How much you read, hear, or consume matters less than how much you can actually produce. What you can explain clearly, write down, organize, and publish, that part becomes yours.

A couple of weeks ago, I decided to study the training process of large language models and explain it in a way that even non-specialists could follow. While doing that, I realized the process itself was worth sharing, because my way of learning now feels much closer to writing code than to traditional studying.
...
After that comes the real labor. I go section by section, filling in every part, adding missing explanations, and making the whole thing complete. It feels a lot like exam review back in school. What I usually end up with is a very long draft, and a wordy one too. This is where AI helps. I ask it to keep my meaning and tone while helping me remove useless repetition, fix weak transitions, point out places where the logic is incomplete, and identify missing background knowledge. In that process, AI is not writing the article for me. It helps me organize the article, cut repetition, and find what I missed. A lot of times I learn more at this stage, because some missing pieces only become obvious after the draft already exists.

That's why I find AI most useful when I'm working on something I want to finish. If all you do is ask AI to summarize things, it is easy to feel productive while building nothing solid in your own mind. When you are seriously trying to write something, explain something, or build something, AI becomes much more useful. The tool amplifies what you are already doing.
...
For me, this whole process made one thing clearer. In the AI era, learning is much faster than before, but depth still does not come for free. AI can help with collecting, translating, cleaning, organizing, comparing, and refining. It can make the whole process much more efficient. How deeply you learn still depends on your judgment, patience, standards, and willingness to turn what you've read into something you can explain. That part has not changed. Now it matters even more.
