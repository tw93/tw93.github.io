...
summary: AI has made it dramatically easier to produce both content and software. That means the world will be filled with products that look finished and mostly work, while our collective standard for quality keeps slipping. When almost anyone can ship a usable app, what still separates real engineers is no longer speed alone, but depth, judgment, systems thinking, and the ability to build something solid enough to last.
categories: Thought
lang: en-US
