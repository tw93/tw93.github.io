...
Six months of heavy Claude Code use, two accounts, roughly $40 per month. This is what came out of that.
...
Based on the six-layer framework in this handbook, I packaged these checks into an open-source skill project, [`tw93/waza`](https://github.com/tw93/waza), which can evaluate your Claude Code configuration in one pass.
