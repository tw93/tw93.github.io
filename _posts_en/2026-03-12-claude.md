...
What Claude actually needs is "did it pass, and if not, where did it fail." Everything else is noise. RTK rewrites commands transparently via a hook, so Claude Code never notices it.

Section 6 covers `| head -30` as a quick manual truncation trick. RTK does the same thing more broadly without having to add it to every command individually. The project is [open source on GitHub](https://github.com/rtk-ai/rtk).
...
<img src="https://cdn.fliggy.com/upic/2EQvo4.png" width="1000" />
...
<img src="https://cdn.fliggy.com/upic/ToAEL8.png" width="1000px" alt="Hooks intervention points in execution flow">
