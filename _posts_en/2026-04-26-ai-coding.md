...
categories: Share
feature: /images/2026/ai-coding/01-cover-en.png
---

<img src="/images/2026/ai-coding/01-cover-en.png" alt="AI Coding cover image: getting started, scenarios, and practice" width="1000" />
...
<img src="/images/2026/ai-coding/02-chatbot-vs-claude-code-en.png" width="900" alt="Chatbot AI vs Claude Code: the former needs back-and-forth shuttling, the latter executes the full loop in your project">
...
<img src="/images/2026/ai-coding/03-kaku-terminal.jpg" width="900" alt="Kaku terminal default UI: a terminal built for AI Coding, install-and-go, light/dark mode follows the system">
...
Three books I'd recommend for non-engineers: [*INSPIRED*](https://www.amazon.com/INSPIRED-Create-Tech-Products-Customers/dp/1119387507) for product judgment, [*Linux and the Unix Philosophy*](https://www.amazon.com/Linux-Unix-Philosophy-Mike-Gancarz/dp/1555582737) for engineering philosophy, and [《左耳听风》](https://book.douban.com/subject/36667269/) (in Chinese) for the engineering perspective of Chen Hao, whom I miss. These can make technical conversations with AI easier to follow.
...
I've tried a fair number of AI Coding tools, including Cursor and Windsurf, and I use Codex sometimes. Claude Code is still my main tool.
...
<img src="/images/2026/ai-coding/04-claude-code-loop-en.png" width="900" alt="Claude Code work loop: you give a task, it reads, edits, runs, verifies, then comes back to you when the loop completes">
...
<img src="/images/2026/ai-coding/05-pattern-shift-en.png" width="900" alt="Two checks for whether to hand a task to it: is the goal clear, is the result easy to verify, both yes means a good fit">
...
<img src="/images/2026/ai-coding/06-software-for-one-en.png" width="900" alt="Software for many vs Software for one: don't build for a million people, build for one, yourself">

### A pace from one day to three months

Don't start by trying to build "something like Notion." A pace that works:

<img src="/images/2026/ai-coding/07-one-day-to-three-months-en.png" width="900" alt="A pace from one day to three months: day 1 try, week 1 taste, month 1 ship a wedge, month 3 build a real software-for-one tool">
...
<img src="/images/2026/ai-coding/08-opencli-routines-en.png" width="900" alt="OpenCLI + Routines automation chain: web operations wrapped as CLI commands, then chained into one-click flows by Routines">
...
<img src="/images/2026/ai-coding/09-claude-md-en.png" width="900" alt="CLAUDE.md is the project-level set of working rules: read every startup, sits as the always-on baseline, the shorter and more command-like the better">
...
<img src="/images/2026/ai-coding/10-requirement-precision-en.png" width="900" alt="Requirement precision comparison: vague one-liner makes it guess and shoot wide, precise paragraph nails single-file, list, detail, filter, storage in one go">
...
2. Default language must be Simplified Chinese (zh-CN), working for Chinese
...
You don't need to write Swift, but you do need to write the requirement **this specifically**. Every line addresses a problem yetone has run into or anticipated. Each concrete detail can save another round of rework.

<img src="/images/2026/ai-coding/11-detail-granularity-en.png" width="900" alt="Three levels of requirement granularity: more detail means less guessing and lower rework rate">
...
<img src="/images/2026/ai-coding/12-default-vs-plan-mode-en.png" width="900" alt="Default mode executes directly and may drift, Plan mode adds a confirmation step that lets you align on direction before letting it run">
...
<img src="/images/2026/ai-coding/13-three-layer-verification-en.png" width="900" alt="Three layers of verification: did the commands pass, did you actually look, did you check against the list; all three are needed before it's done">
...
<img src="/images/2026/ai-coding/14-diagnose-first-en.png" width="900" alt="The try-this-try-that loop: error → patch → new error → patch again, vs the direct path of nailing the root cause first then fixing once">
...
<img src="/images/2026/ai-coding/15-context-compaction-en.png" width="900" alt="Long session compaction: the reasoning behind early decisions is the first thing dropped, the 'preserve when compacting' section is what keeps the session coherent">
...
<img src="/images/2026/ai-coding/17-skill-types-en.png" width="900" alt="Three most useful Skill types: workflow, checklist, domain expert">
...
<img src="/images/2026/ai-coding/18-kami-output.png" width="900" alt="Kami output: warm parchment background, ink-blue accent, serif type, supports resume, one-pager, slides, eight templates total">
...
<img src="/images/2026/ai-coding/19-claude-design-ui.png" width="900" alt="Claude Design UI: upload a screenshot, get an interactive prototype, slide deck, or landing page back">
...
<img src="/images/2026/ai-coding/20-safety-habits-en.png" width="900" alt="Safety habits to start with: explain first, understand first, no production practice, never paste secrets">
