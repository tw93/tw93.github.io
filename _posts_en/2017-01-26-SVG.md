...
<img src="{{ site.assetUrl }}SVG.png" loading="lazy" decoding="async" />
...
<img src="{{ site.assetUrl }}loading.gif" loading="lazy" decoding="async" />

Last week, the team had a small hackthon, which was to draw this Loading GIF through code. Then learned while using SVG to write a same loading. Volume changed from previous GIF's 33KB to 864B SVG. Details see below:

{::nomarkdown}
<p data-height="300" data-theme-id="27375" data-slug-hash="oBYGrZ" data-default-tab="js,result" data-user="tw93" data-embed-version="2" data-pen-title="Loading Animation" class="codepen" data-preview="true">See the Pen <a href="http://codepen.io/tw93/pen/oBYGrZ/">Loading Animation</a> by Tw93 (<a href="http://codepen.io/tw93">@tw93</a>) on <a href="http://codepen.io">CodePen</a>.</p>
...
<img src="{{ site.assetUrl }}position.png" loading="lazy" decoding="async" />
...
<img src="{{ site.assetUrl }}svgshape.png-1280" class="img-zoom" loading="lazy" decoding="async"/>
...
<img src="{{ site.assetUrl }}SVG-animation.png-1280" class="img-zoom" loading="lazy" decoding="async"/>
...
<img src="{{ site.assetUrl }}Jietu20170126-180043.jpg-1280" class="img-zoom" loading="lazy" decoding="async"/>
...
<img src="{{ site.assetUrl }}Jietu20170126-173506.jpg-1280" class="img-zoom" loading="lazy" decoding="async"/>
