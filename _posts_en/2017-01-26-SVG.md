...
Last week, the team (😂😂 shamelessly insert a very hard advertisement, Alibaba Fliggy front-end team is recruiting, details: [Fliggy looking for front-end students](http：//www.dfkhgj.com/markets/h5/fliggy/f2e){:target="_blank"}) had a small hackthon, which was to draw this Loading GIF through code. Then learned while using SVG to write a same loading. Volume changed from previous GIF's 33KB to 864B SVG. Details see below:
