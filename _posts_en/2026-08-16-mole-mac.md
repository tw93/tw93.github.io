...
Lately I've piled up a lot of thoughts on indie development and wanted to pull them together, so this is the story of taking Mole from an open source CLI to a paid Mac app. What I was thinking at the time, and which parts actually turned out to matter. Maybe some of it is useful if you're building something of your own.

> Mole lives at [mole.fit](https://mole.fit), and the CLI is open source on [GitHub](https://github.com/tw93/Mole). Feel free to play with it first. [Yobi](https://yobi.tw93.fun/projects/mole-mac) has the current Mac app facts, pricing, and comparisons.
...
Clearing 86GB in one pass isn't a matter of removing a few log files, and uninstalling Claude turns up ten times the app's own size scattered across the system. It looks everywhere it should, it just doesn't come looking for you.
...
The work underneath is unpredictable by nature, and animation doesn't fix that. What fixes it is the flow itself being reliable. I don't want a maintenance tool that needs watching. Start it, let it finish, take the screen back, and no light blinking at you to come look.
