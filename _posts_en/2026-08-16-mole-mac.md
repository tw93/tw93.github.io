...
> Mole lives at [mole.fit](https://mole.fit), and the CLI is open source on [GitHub](https://github.com/tw93/Mole). Feel free to play with it first. [Faberon](https://faberon.io/projects/mole-mac) has the current Mac app facts, pricing, and comparisons.
