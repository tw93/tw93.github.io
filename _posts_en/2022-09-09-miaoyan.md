---
layout: post
title: "MiaoYan: A Native Markdown Editor for macOS"
poem: 書不盡言，言不盡意
date: 2022-09-09 19:00:00
summary: MiaoYan is a native, local-first Markdown editor for macOS with plain-text folders, split preview, LaTeX, Mermaid, and keyboard-first workflows.
categories: Creation
---

## TL;DR

> MiaoYan is open source on [GitHub](https://github.com/tw93/MiaoYan). [Yobi](https://yobi.tw93.fun/projects/miaoyan) has the project facts and comparisons.

MiaoYan first appeared publicly in a [V2EX post](https://www.v2ex.com/t/858941) three months ago. I had been tinkering with it since 2020 and finally felt it was ready for other people that June. Since then I have shipped [20 releases](https://github.com/tw93/MiaoYan/releases/), closed 138 issues, picked up 2.2K GitHub stars and 1.7K followers on Twitter, met a lot of genuinely nice technical friends, and reached around 7K users. [Thirty-three](https://cats.tw93.fun) of them have even chosen to feed the cat.

Here I want to walk through what MiaoYan does, why I think it fits engineers, and a few of the product decisions behind it. Screenshots and demos are near the end.

<img src="https://cdn.tw93.fun/blog/upic/x6ko88.png" width=800 alt="MiaoYan's native three-column Markdown editor"/>
...
<img src="https://gw.alipayobjects.com/zos/k/4f/ch.gif" width=700 alt="MiaoYan interface and editing workflow"/>

### Quickly write PPT

<img src="https://gw.alipayobjects.com/zos/k/app2/123.gif" width=700 alt="Creating a presentation quickly in MiaoYan"/>

### One-click formatting

<img src="https://cdn.tw93.fun/blog/upic/x4RoKi.gif" width=700 alt="Formatting a Markdown document in MiaoYan"/>

### Instant editing in progress

<img src="https://gw.alipayobjects.com/zos/k/ir/0thdx-xps0k.gif" width=700 alt="MiaoYan instant editing demo"/>
