---
layout: post
title: My Favorite Tools and Gadgets
poem: 工欲善其事，必先利其器
date: 2024-02-09 16:00:00
summary: Recently, taking advantage of the holiday downtime, I organized some of the best Mac software, websites, and lifestyle products I've used over the year. Following the principles of simplicity, usability, and aesthetics, I hope this can offer some guidance when you face similar choices.
categories: Share
feature: https://img.alicdn.com/imgextra/i1/O1CN01kIwTkb1D3mgkwzqtV_!!6000000000161-0-tps-5712-4284.jpg
lang: en-US
---

Leveraging the recent holiday break, I took the opportunity to organize a list of Mac software, websites, and daily life products that I've found particularly useful over the past year. I've always valued simplicity, ease of use, and beauty in my tools, hoping to provide some guidance when you face similar choices.

## Mac Software

This year, I didn't venture into new software territories as much as refining and optimizing my current toolkit for a more comfortable experience. I aimed to avoid duplicating tools with similar functionalities, keeping to the principle of simplicity and beauty. Here are some of the Mac applications I've favored this year. If you enjoy experimenting with new tools, you might find some of these worth trying.

![](https://cdn.tw93.fun/blog/upic/x7M782.png)

### Favorites of the Year

1. [**MiaoYan**](https://github.com/tw93/MiaoYan/): A simple and easy-to-use native Markdown note-taking app I developed 3 years ago, continuously updated throughout its use.
2. [**ChatGPT Desktop**](https://github.com/tw93/Pake): A desktop version of the official GPT webpage, packaged using my own Pake tool, with injected styles and scripts for enhanced usability, invoked through shortcuts for daily use.
...
4. [**Alacritty**](https://github.com/alacritty/alacritty): A command-line terminal written in Rust. I've previously written about improving the "fastest terminal" in a [blog post](https://tw93.fun/2023-02-06/alacritty.html), highlighting its speed, simplicity, and beauty.
...
3. [**Things**](https://culturedcode.com/things/): A simple and clean to-do app—its simplicity actually helps me focus more on the tasks at hand.
...
8. **Mail**—yes, the default Apple Mail app. It can be easily configured for a cleaner interface, allowing for a more efficient email management experience.

### Efficiency Tools

1. [**Edge Browser**](https://www.microsoft.com/en-us/edge): I have a love-hate relationship with this browser. I tried Arc but found it somewhat complex, barely lasting a week. The primary reason I stick with Edge is its vertical tab bar and impressive performance speed. I've written about my browser journey in 2023 in this blog post, [My 2023 Browser Odyssey](https://tw93.fun/2023-08-20/edge.html), for reference.
...
![](https://cdn.tw93.fun/blog/upic/qCwDNl.png)
...
1. [**macOSicons**](https://macosicons.com/#/): Over 5,000 free icons for macOS and iOS, commonly used to replace unattractive app icons for a unified style.
2. [**Pexels**](https://www.pexels.com/): A website offering free images and video materials.
...
5. [**Mockups Design**](https://mockups-design.com/): A free high-quality mockup material download website, offering real-world templates like 3D objects, brochures, and business cards in PSD format.
...
![](https://cdn.tw93.fun/blog/upic/5y33k2.jpg)
...
3. **Headphones**: AirPods Pro 2, having used Pro 1 for about 3 years before selling all other headphones. Now, this is my only headphone, fully satisfying my daily needs.
...
2. **Air Fryer**: Panasonic NF-HCSAM400, bought on a whim at Sam's for 299 RMB. It's frequently used for baking bread and chicken wings, performing well and looking great in white.
...
1. **Toy Car**: Tesla Model 3 in red, looks just like the toy cars I adored in my childhood. I love products with simple beauty. It's been over 2 years since the purchase, and the pros far outweigh the cons, significantly expanding my life's radius.
...
1. **Doorbell**: [Xiaomi Smart Doorbell 3](https://u.jd.com/j8NqbVV), this sub-300 RMB item I consider the most worthwhile purchase. A single charge lasts half a year, serving as both an outdoor camera and doorbell. Installed above the door lock, it matches the existing lock without being obtrusive.
