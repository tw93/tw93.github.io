---
layout: post
title: "Pake: Turn Any Web Page into a Lightweight Desktop App"
poem: 別有天地非人間
date: 2023-08-03 21:00:00
summary: Pake uses Rust and Tauri to turn any web page into a small, fast desktop app. This article covers its open-source journey and engineering choices.
categories: Creation
---

This article grew out of a talk I gave at Juejin's cross-platform engineering event last Thursday. I shared what I learned while open-sourcing [**Pake**](https://github.com/tw93/pake), then wandered into frontend engineering, Rust, open source, and what it takes to turn a technical idea into a product. If anything is unclear, tell me.

[Faberon](https://faberon.io/projects/pake) has the current feature, installation, and comparison notes.

It has two parts: first the keynote and talk video, then my notes from preparing the talk, with a deeper look at Rust.
